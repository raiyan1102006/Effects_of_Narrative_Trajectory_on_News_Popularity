...
Companion code for the project "Understanding the Effects of Narrative Trajectories on the Popularity of Online News Articles".
...
This program is createdin Python 3.6.3, and tested in the mac OS platform.
